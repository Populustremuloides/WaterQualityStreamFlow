...
df.to_csv("minmax_prediction_results_flowonly.csv", index=False)

df = pd.DataFrame.from_dict(featureImportances)
df.to_csv("minmax_prediction_featureImportances_flowonly.csv", index=False)
